" Vim color file
" Converted from Textmate theme Sourlick using Coloration v0.3.2 (http://github.com/sickill/coloration)
...
hi MatchParen ctermfg=185 ctermbg=NONE cterm=NONE guifg=#d2eb31 guibg=NONE gui=NONE
...
hi IncSearch ctermfg=NONE ctermbg=58 cterm=NONE guifg=NONE guibg=#646b2d gui=NONE
hi Search ctermfg=NONE ctermbg=58 cterm=NONE guifg=NONE guibg=#646b2d gui=NONE
...
hi Identifier ctermfg=227 ctermbg=NONE cterm=NONE guifg=#edf252 guibg=NONE gui=italic
...
hi PreProc ctermfg=185 ctermbg=NONE cterm=NONE guifg=#d2eb31 guibg=NONE gui=NONE
...
hi StorageClass ctermfg=227 ctermbg=NONE cterm=NONE guifg=#edf252 guibg=NONE gui=italic
hi String ctermfg=191 ctermbg=NONE cterm=NONE guifg=#e4ff33 guibg=NONE gui=NONE
hi Tag ctermfg=76 ctermbg=NONE cterm=NONE guifg=#70c910 guibg=NONE gui=NONE
...
hi rubyInclude ctermfg=185 ctermbg=NONE cterm=NONE guifg=#d2eb31 guibg=NONE gui=NONE
...
hi rubyException ctermfg=185 ctermbg=NONE cterm=NONE guifg=#d2eb31 guibg=NONE gui=NONE
...
hi javaScriptFunction ctermfg=227 ctermbg=NONE cterm=NONE guifg=#edf252 guibg=NONE gui=italic
hi javaScriptRailsFunction ctermfg=214 ctermbg=NONE cterm=NONE guifg=#ffbb29 guibg=NONE gui=NONE
hi javaScriptBraces ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi yamlKey ctermfg=76 ctermbg=NONE cterm=NONE guifg=#70c910 guibg=NONE gui=NONE
...
hi cssPseudoClassId ctermfg=214 ctermbg=NONE cterm=NONE guifg=#ffbb29 guibg=NONE gui=NONE
hi cssClassName ctermfg=214 ctermbg=NONE cterm=NONE guifg=#ffbb29 guibg=NONE gui=NONE
