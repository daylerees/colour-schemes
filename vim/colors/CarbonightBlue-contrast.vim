...
hi Cursor ctermfg=234 ctermbg=203 cterm=NONE guifg=#181b1c guibg=#f83333 gui=NONE
hi Visual ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#433131 gui=NONE
hi CursorLine ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#272a2b gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#272a2b gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#272a2b gui=NONE
hi LineNr ctermfg=241 ctermbg=235 cterm=NONE guifg=#646666 guibg=#272a2b gui=NONE
hi VertSplit ctermfg=238 ctermbg=238 cterm=NONE guifg=#444647 guibg=#444647 gui=NONE
hi MatchParen ctermfg=254 ctermbg=NONE cterm=underline guifg=#e3e3e3 guibg=NONE gui=underline
hi StatusLine ctermfg=249 ctermbg=238 cterm=bold guifg=#b0b0b0 guibg=#444647 gui=bold
hi StatusLineNC ctermfg=249 ctermbg=238 cterm=NONE guifg=#b0b0b0 guibg=#444647 gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=59 cterm=NONE guifg=NONE guibg=#433131 gui=NONE
hi IncSearch ctermfg=234 ctermbg=110 cterm=NONE guifg=#181b1c guibg=#77acc5 gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=249 ctermbg=NONE cterm=NONE guifg=#b0b0b0 guibg=NONE gui=NONE
hi Folded ctermfg=59 ctermbg=234 cterm=NONE guifg=#3f5b69 guibg=#181b1c gui=NONE

hi Normal ctermfg=249 ctermbg=234 cterm=NONE guifg=#b0b0b0 guibg=#181b1c gui=NONE
...
hi DiffAdd ctermfg=249 ctermbg=64 cterm=bold guifg=#b0b0b0 guibg=#43810a gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#880506 guibg=NONE gui=NONE
hi DiffChange ctermfg=249 ctermbg=23 cterm=NONE guifg=#b0b0b0 guibg=#1c3352 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=235 cterm=NONE guifg=#3b3a32 guibg=#272a2b gui=NONE
