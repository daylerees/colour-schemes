" Vim color file
" Converted from Textmate theme Earthsong Light using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi MatchParen ctermfg=166 ctermbg=NONE cterm=underline guifg=#d45c28 guibg=NONE gui=underline
...
hi IncSearch ctermfg=15 ctermbg=178 cterm=NONE guifg=#ffffff guibg=#db9d18 gui=NONE
...
hi DiffAdd ctermfg=95 ctermbg=149 cterm=bold guifg=#7d6852 guibg=#a1e85d gui=bold
hi DiffDelete ctermfg=203 ctermbg=NONE cterm=NONE guifg=#f25454 guibg=NONE gui=NONE
hi DiffChange ctermfg=95 ctermbg=152 cterm=NONE guifg=#7d6852 guibg=#b9cfe7 gui=NONE
hi DiffText ctermfg=95 ctermbg=74 cterm=bold guifg=#7d6852 guibg=#729fcf gui=bold
