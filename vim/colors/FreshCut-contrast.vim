" Vim color file
" Converted from Textmate theme FreshCut using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=234 ctermbg=231 cterm=NONE guifg=#1a1b1b guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#2e3b3b gui=NONE
hi CursorLine ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#303131 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#303131 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#303131 gui=NONE
hi LineNr ctermfg=245 ctermbg=236 cterm=NONE guifg=#898a87 guibg=#303131 gui=NONE
hi VertSplit ctermfg=240 ctermbg=240 cterm=NONE guifg=#5a5b59 guibg=#5a5b59 gui=NONE
hi MatchParen ctermfg=188 ctermbg=NONE cterm=underline guifg=#c8d7e8 guibg=NONE gui=underline
hi StatusLine ctermfg=231 ctermbg=240 cterm=bold guifg=#f8f8f2 guibg=#5a5b59 gui=bold
hi StatusLineNC ctermfg=231 ctermbg=240 cterm=NONE guifg=#f8f8f2 guibg=#5a5b59 gui=NONE
hi Pmenu ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#2e3b3b gui=NONE
hi IncSearch ctermfg=234 ctermbg=190 cterm=NONE guifg=#1a1b1b guibg=#e9ee00 gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=106 ctermbg=NONE cterm=NONE guifg=#8fbe00 guibg=NONE gui=NONE
hi Folded ctermfg=59 ctermbg=234 cterm=NONE guifg=#556270 guibg=#1a1b1b gui=NONE

hi Normal ctermfg=231 ctermbg=234 cterm=NONE guifg=#f8f8f2 guibg=#1a1b1b gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#f8f8f2 guibg=#44810a gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#880505 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#f8f8f2 guibg=#1d3351 gui=NONE
...
hi NonText ctermfg=59 ctermbg=235 cterm=NONE guifg=#3b3a32 guibg=#252626 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=236 cterm=NONE guifg=#3b3a32 guibg=#303131 gui=NONE
