" Vim color file
" Converted from Textmate theme Laravel Darker using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
let g:colors_name = "Laravel Darker"
...
hi CursorLine ctermfg=NONE ctermbg=233 cterm=NONE guifg=NONE guibg=#161616 gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=233 cterm=NONE guifg=NONE guibg=#161616 gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=233 cterm=NONE guifg=NONE guibg=#161616 gui=NONE
hi LineNr ctermfg=242 ctermbg=233 cterm=NONE guifg=#6f6f6f guibg=#161616 gui=NONE
hi VertSplit ctermfg=238 ctermbg=238 cterm=NONE guifg=#404040 guibg=#404040 gui=NONE
hi MatchParen ctermfg=214 ctermbg=NONE cterm=underline guifg=#ffa927 guibg=NONE gui=underline
hi StatusLine ctermfg=253 ctermbg=238 cterm=bold guifg=#dedede guibg=#404040 gui=bold
hi StatusLineNC ctermfg=253 ctermbg=238 cterm=NONE guifg=#dedede guibg=#404040 gui=NONE
...
hi Normal ctermfg=253 ctermbg=0 cterm=NONE guifg=#dedede guibg=#000000 gui=NONE
...
hi DiffAdd ctermfg=253 ctermbg=64 cterm=bold guifg=#dedede guibg=#3e7b05 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#830000 guibg=NONE gui=NONE
hi DiffChange ctermfg=253 ctermbg=17 cterm=NONE guifg=#dedede guibg=#102544 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=233 cterm=NONE guifg=#3b3a32 guibg=#161616 gui=NONE
