" Vim color file
" Converted from Textmate theme Last Night using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=234 ctermbg=39 cterm=NONE guifg=#1d1f21 guibg=#00bdff gui=NONE
...
hi DiffAdd ctermfg=59 ctermbg=64 cterm=bold guifg=#47494a guibg=#44810b gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#890607 guibg=NONE gui=NONE
hi DiffChange ctermfg=59 ctermbg=23 cterm=NONE guifg=#47494a guibg=#1e3554 gui=NONE
hi DiffText ctermfg=59 ctermbg=24 cterm=bold guifg=#47494a guibg=#204a87 gui=bold
