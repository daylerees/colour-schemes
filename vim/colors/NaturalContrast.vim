" Vim color file
" Converted from Textmate theme Natural Contrast Theme using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=16 ctermbg=144 cterm=NONE guifg=#1b2016 guibg=#9ebb80 gui=NONE
...
hi MatchParen ctermfg=144 ctermbg=NONE cterm=underline guifg=#9ebb80 guibg=NONE gui=underline
...
hi IncSearch ctermfg=16 ctermbg=153 cterm=NONE guifg=#1b2016 guibg=#aeceff gui=NONE
...
hi DiffAdd ctermfg=15 ctermbg=64 cterm=bold guifg=#ffffff guibg=#448209 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#890604 guibg=NONE gui=NONE
hi DiffChange ctermfg=15 ctermbg=23 cterm=NONE guifg=#ffffff guibg=#1e354f gui=NONE
