...
hi IncSearch ctermfg=15 ctermbg=67 cterm=NONE guifg=#ffffff guibg=#4687b8 gui=NONE
...
hi DiffAdd ctermfg=240 ctermbg=149 cterm=bold guifg=#585856 guibg=#a1e85d gui=bold
hi DiffDelete ctermfg=203 ctermbg=NONE cterm=NONE guifg=#f25454 guibg=NONE gui=NONE
hi DiffChange ctermfg=240 ctermbg=152 cterm=NONE guifg=#585856 guibg=#b9cfe7 gui=NONE
hi DiffText ctermfg=240 ctermbg=74 cterm=bold guifg=#585856 guibg=#729fcf gui=bold
