" Vim color file
" Converted from Textmate theme Spearmint using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=195 ctermbg=231 cterm=NONE guifg=#e1f0ee guibg=#f8f8f0 gui=NONE
...
hi MatchParen ctermfg=73 ctermbg=NONE cterm=underline guifg=#4fa89c guibg=NONE gui=underline
