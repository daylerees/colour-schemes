" Vim color file
" Converted from Textmate theme TronLegacy using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Folded ctermfg=66 ctermbg=16 cterm=NONE guifg=#5f7794 guibg=#14191f gui=NONE
...
hi Comment ctermfg=66 ctermbg=NONE cterm=NONE guifg=#5f7794 guibg=NONE gui=NONE
...
hi Todo ctermfg=66 ctermbg=NONE cterm=inverse,bold guifg=#5f7794 guibg=NONE gui=inverse,bold
...
hi erubyComment ctermfg=66 ctermbg=NONE cterm=NONE guifg=#5f7794 guibg=NONE gui=NONE
