" Vim color file
" Converted from Textmate theme Tron using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Folded ctermfg=60 ctermbg=16 cterm=NONE guifg=#516a88 guibg=#14191f gui=NONE
