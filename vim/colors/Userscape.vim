" Vim color file
" Converted from Textmate theme Userscape using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=231 ctermbg=231 cterm=NONE guifg=#f5f8fc guibg=#f8f8f0 gui=NONE
