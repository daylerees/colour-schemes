...
hi Normal      guibg=#25272f  guifg=#ffffff    gui=none ctermbg=0 ctermfg=15
...
hi Question    guibg=bg guifg=#00aba5   ctermbg=bg ctermfg=10
...
hi Comment  guibg=bg  guifg=#666666  gui=none    ctermbg=8   ctermfg=7

hi Constant    guibg=bg    guifg=white        ctermbg=8   ctermfg=15
hi String      guibg=bg    guifg=#7fb660    ctermbg=bg  ctermfg=14
hi Character   guibg=bg    guifg=#52bd58      ctermbg=bg  ctermfg=14
hi Number      guibg=bg    guifg=#8485ce      ctermbg=1   ctermfg=15
hi Boolean     guibg=bg    guifg=#8485ce  gui=none    ctermbg=1   ctermfg=15
hi Float       guibg=bg    guifg=#8485ce      ctermbg=1   ctermfg=15

hi Identifier  guibg=bg    guifg=#ffffff      ctermbg=bg  ctermfg=12
hi Function    guibg=bg    guifg=#52bd58      ctermbg=bg  ctermfg=12
hi Statement   guibg=bg    guifg=#52bd58      ctermbg=bg  ctermfg=14

hi Conditional guibg=bg    guifg=#00aba5      ctermbg=bg  ctermfg=12
hi Repeat      guibg=bg    guifg=#00aba5      ctermbg=4   ctermfg=14
hi Label       guibg=bg    guifg=#ffccff      ctermbg=bg   ctermfg=13
hi Operator    guibg=bg    guifg=#00aba5      ctermbg=6   ctermfg=15
hi Keyword     guibg=bg    guifg=#00aba5      ctermbg=bg  ctermfg=10
hi Exception   guibg=bg    guifg=#52bd58      ctermbg=bg  ctermfg=10

hi PreProc    guibg=bg   guifg=#ffcc99   ctermbg=4  ctermfg=14
hi Include    guibg=bg   guifg=#00aba5   ctermbg=bg ctermfg=10
hi link Define    Include
hi link Macro     Include
hi link PreCondit Include

hi Type       guibg=bg   guifg=#00aba5      ctermbg=bg  ctermfg=12
hi StorageClass   guibg=bg   guifg=#52bd58      ctermbg=bg  ctermfg=10
hi Structure      guibg=bg   guifg=#ffffff      ctermbg=bg  ctermfg=10
hi Typedef    guibg=bg   guifg=#00aba5    ctermbg=bg  ctermfg=10
...
hi SpecialComment guibg=#334455  guifg=#999999    ctermbg=1   ctermfg=15
