...
hi Normal      guibg=#0000FF  guifg=#ffffff    gui=none ctermbg=0 ctermfg=15
...
hi Question    guibg=bg guifg=#ffffff   ctermbg=bg ctermfg=10
...
hi Comment  guibg=bg  guifg=#ffffff  gui=none    ctermbg=8   ctermfg=7
...
hi Conditional guibg=bg    guifg=#ffffff      ctermbg=bg  ctermfg=12
hi Repeat      guibg=bg    guifg=#ffffff      ctermbg=4   ctermfg=14
hi Label       guibg=bg    guifg=#ffccff      ctermbg=bg   ctermfg=13
hi Operator    guibg=bg    guifg=#ffffff      ctermbg=6   ctermfg=15
hi Keyword     guibg=bg    guifg=#ffffff      ctermbg=bg  ctermfg=10
hi Exception   guibg=bg    guifg=#ffffff      ctermbg=bg  ctermfg=10

hi PreProc    guibg=bg   guifg=#ffcc99   ctermbg=4  ctermfg=14
hi Include    guibg=bg   guifg=#ffffff   ctermbg=bg ctermfg=10
hi link Define    Include
hi link Macro     Include
hi link PreCondit Include

hi Type       guibg=bg   guifg=#ffffff      ctermbg=bg  ctermfg=12
hi StorageClass   guibg=bg   guifg=#ffffff      ctermbg=bg  ctermfg=10
hi Structure      guibg=bg   guifg=#ffffff      ctermbg=bg  ctermfg=10
hi Typedef    guibg=bg   guifg=#ffffff    ctermbg=bg  ctermfg=10
...
hi SpecialComment guibg=#334455  guifg=#ffffff    ctermbg=1   ctermfg=15
...
let g:colors_name = "Doogie"
let colors_name   = "Doogie"
